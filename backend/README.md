...
## Project Structure
    ...
    ├── lingering_night_dev_88902  # Django project configurations
...
1. Clone this repo and `cd lingering_night_dev_88902`
...
2. Clone this repo and `cd lingering_night_dev_88902`
